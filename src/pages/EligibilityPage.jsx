      ...
      <div className="text-slate-50">
        <section className="relative pt-28 pb-16 border-b border-white/5">
          ...
          <div style={{ width: 'var(--container-narrow)', marginInline: 'auto', padding: '0 1rem' }} className="text-center">
            ...
            <h1 className="font-display font-bold text-white mt-4 mb-5"
              style={{ fontSize: 'var(--fs-4xl)', letterSpacing: '-0.03em', lineHeight: 1.04 }}>
              {content.page_heading}
            </h1>
            <p className="text-slate-300 max-w-xl mx-auto" style={{ fontSize: 'var(--fs-lg)' }}>
              {content.page_intro}
            </p>
          </div>
        </section>
        ...
        <section className="py-12" style={{ width: 'min(640px, 92vw)', marginInline: 'auto', padding: '3rem 1rem' }}>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    className="bg-slate-950/60 border-slate-700/60 focus:border-blue-500 h-11"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                 <div className="space-y-2">
                  ...
                  <Select required onValueChange={(val) => handleChange('origin_country', val)} value={formData.origin_country}>
                    <SelectTrigger className="bg-slate-950/60 border-slate-700/60 focus:border-blue-500 h-11"><SelectValue placeholder="Select Country" /></SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  <Select required onValueChange={(val) => { handleChange('target_destination', val); handleChange('intake_month', ''); }} value={formData.target_destination}>
                    <SelectTrigger className="bg-slate-950/60 border-slate-700/60 focus:border-blue-500 h-11"><SelectValue placeholder="Select Destination" /></SelectTrigger>
                    <SelectContent>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select required onValueChange={(val) => handleChange('study_level', val)} value={formData.study_level}>
                    <SelectTrigger className="bg-slate-950/60 border-slate-700/60 focus:border-blue-500 h-11"><SelectValue placeholder="Select Level" /></SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  <Select required onValueChange={(val) => handleChange('budget_range', val)} value={formData.budget_range}>
                    <SelectTrigger className="bg-slate-950/60 border-slate-700/60 focus:border-blue-500 h-11"><SelectValue placeholder="Select Budget" /></SelectTrigger>
                    <SelectContent>
               ...
               <div className="space-y-2">
                  ...
                  <Select required onValueChange={(val) => handleChange('intake_month', val)} value={formData.intake_month}>
                    <SelectTrigger className="bg-slate-950/60 border-slate-700/60 focus:border-blue-500 h-11"><SelectValue placeholder="Select Month" /></SelectTrigger>
                    <SelectContent>
                      {(formData.target_destination === 'Poland'
                        ? ['February', 'September']
                        : formData.target_destination === 'Germany'
                        ? ['April', 'October']
